...
| summary_generation_mode | [int32](#int32) |  | summary_generation_mode identifies the evidence content category and is distinct from Document.mime. 0 = static, 1 = dynamic. |
