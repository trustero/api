...
type Finding struct {
	...
	ReceptorType string `protobuf:"bytes,1,opt,name=receptor_type,json=receptorType,proto3" json:"receptor_type,omitempty"` // REMIND maps to Receptor.ModelID
	//*
	//The receptor's evidence source.
	ServiceProviderAccount string `protobuf:"bytes,2,opt,name=service_provider_account,json=serviceProviderAccount,proto3" json:"service_provider_account,omitempty"` // REMIND maps to Receptor.TenantID
	//*
...
type Evidence struct {
	...
	RawApiRequest string `protobuf:"bytes,4,opt,name=raw_api_request,json=rawApiRequest,proto3" json:"raw_api_request,omitempty"`
	//*
	//The raw API response used to generate this evidence.  The raw API request and response is used to prove to
	//examiners this evidence correlates to real service instance configuration.
	RawApiResponse string `protobuf:"bytes,5,opt,name=raw_api_response,json=rawApiResponse,proto3" json:"raw_api_response,omitempty"`
	//*
...
func (x *Evidence) GetRawApiRequest() string {
	if x != nil {
...
func (x *Evidence) GetRawApiResponse() string {
	if x != nil {
...
type ReceptorConfiguration struct {
	...
	//*
	//Trustero receptor record identifier.
	ReceptorObjectId string `protobuf:"bytes,1,opt,name=receptor_object_id,json=receptorObjectId,proto3" json:"receptor_object_id,omitempty"` // REMIND Receptor.ID
	//*
	//Credential required to access a service provider for report finding and discover services purposes.
	Credential string `protobuf:"bytes,2,opt,name=credential,proto3" json:"credential,omitempty"` // REMIND Receptor.Credential required to access the target service.
	//*
	//Additional receptor configuration to access a service provider account.
	Config string `protobuf:"bytes,3,opt,name=config,proto3" json:"config,omitempty"` // REMIND Receptor.config task configuration in json.
	//*
	//Service provider account
	ServiceProviderAccount string `protobuf:"bytes,4,opt,name=service_provider_account,json=serviceProviderAccount,proto3" json:"service_provider_account,omitempty"` // REMIND Receptor.TenantID
}
...
type JobResult struct {
	...
	TracerId string `protobuf:"bytes,1,opt,name=tracer_id,json=tracerId,proto3" json:"tracer_id,omitempty"` // REMIND AyncTask.TracerID for tracking.
	//*
	...
	ReceptorObjectId string `protobuf:"bytes,4,opt,name=receptor_object_id,json=receptorObjectId,proto3" json:"receptor_object_id,omitempty"` // REMIND Receptor.ID
}
...
var file_receptor_v1_receptor_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x65, 0x6e, 0x63, 0x65, 0x73, 0x22, 0xa6, 0x02, 0x0a, 0x08, 0x45, 0x76, 0x69, 0x64,
	...
	0x61, 0x6d, 0x65, 0x12, 0x26, 0x0a, 0x0f, 0x72, 0x61, 0x77, 0x5f, 0x61, 0x70, 0x69, 0x5f, 0x72,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x72, 0x61,
	0x77, 0x41, 0x70, 0x69, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x28, 0x0a, 0x10, 0x72,
	0x61, 0x77, 0x5f, 0x61, 0x70, 0x69, 0x5f, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x18,
	0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x72, 0x61, 0x77, 0x41, 0x70, 0x69, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x29, 0x0a, 0x03, 0x64, 0x6f, 0x63, 0x18, 0x06, 0x20, 0x01,
	...
	0x12, 0x2d, 0x0a, 0x06, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b,
	...
	0x22, 0x51, 0x0a, 0x08, 0x44, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x1d, 0x0a, 0x0a,
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x09, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x49, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x6d,
	...
	,
	...
	0x01, 0x1a, 0x9a, 0x06, 0x0a, 0x03, 0x52, 0x6f, 0x77, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x73,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x49, 0x64, 0x12, 0x35, 0x0a, 0x04, 0x63, 0x6f, 0x6c, 0x73,
	0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x72, 0x65, 0x63, 0x65, 0x70, 0x74, 0x6f,
	0x72, 0x5f, 0x76, 0x31, 0x2e, 0x53, 0x74, 0x72, 0x75, 0x63, 0x74, 0x2e, 0x52, 0x6f, 0x77, 0x2e,
	0x43, 0x6f, 0x6c, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x04, 0x63, 0x6f, 0x6c, 0x73, 0x1a,
	0x56, 0x0a, 0x09, 0x43, 0x6f, 0x6c, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03,
	...
	0x63, 0x74, 0x2e, 0x52, 0x6f, 0x77, 0x2e, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x05, 0x76, 0x61,
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0xe4, 0x04, 0x0a, 0x05, 0x56, 0x61, 0x6c, 0x75,
	...
	0x74, 0x33, 0x32, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x11, 0x48,
	0x00, 0x52, 0x0b, 0x73, 0x69, 0x6e, 0x74, 0x33, 0x32, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x23,
	0x0a, 0x0c, 0x73, 0x69, 0x6e, 0x74, 0x36, 0x34, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x08,
	...
	0x61, 0x6c, 0x75, 0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x07, 0x48, 0x00, 0x52, 0x0c, 0x66, 0x69,
	0x78, 0x65, 0x64, 0x33, 0x32, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x25, 0x0a, 0x0d, 0x66, 0x69,
	0x78, 0x65, 0x64, 0x36, 0x34, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28,
	...
	0x6c, 0x75, 0x65, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0f, 0x48, 0x00, 0x52, 0x0d, 0x73, 0x66, 0x69,
	...
	0x65, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x08, 0x48, 0x00, 0x52, 0x09, 0x62, 0x6f, 0x6f, 0x6c, 0x56,
	0x61, 0x6c, 0x75, 0x65, 0x12, 0x23, 0x0a, 0x0c, 0x73, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x5f, 0x76,
	0x61, 0x6c, 0x75, 0x65, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x0b, 0x73, 0x74,
	0x72, 0x69, 0x6e, 0x67, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x45, 0x0a, 0x0f, 0x74, 0x69, 0x6d,
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x0f, 0x20, 0x01,
	...
	,
	...
	0x6e, 0x63, 0x65, 0x49, 0x64, 0x22, 0xa4, 0x01, 0x0a, 0x0a, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e,
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x3b, 0x0a, 0x0b,
	...
	0x02, 0x0a, 0x08, 0x52, 0x65, 0x63, 0x65, 0x70, 0x74, 0x6f, 0x72, 0x12, 0x3c, 0x0a, 0x06, 0x52,
	...
	0x72, 0x69, 0x6e, 0x67, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x41, 0x0a, 0x0a, 0x44, 0x69, 0x73,
	0x63, 0x6f, 0x76, 0x65, 0x72, 0x65, 0x64, 0x12, 0x15, 0x2e, 0x72, 0x65, 0x63, 0x65, 0x70, 0x74,
	0x6f, 0x72, 0x5f, 0x76, 0x31, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x1a, 0x1c,
	0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66,
	0x2e, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x3b, 0x0a, 0x08,
	...
	0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x38, 0x0a, 0x06, 0x4e,
...
var file_receptor_v1_receptor_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_receptor_v1_receptor_proto_goTypes = []interface{}{
	...
	nil,                            // 9: receptor_v1.Struct.ColDisplayNamesEntry
	(*Struct_Row)(nil),             // 10: receptor_v1.Struct.Row
	nil,                            // 11: receptor_v1.Struct.Row.ColsEntry
	(*Struct_Row_Value)(nil),       // 12: receptor_v1.Struct.Row.Value
	(*Services_Service)(nil),       // 13: receptor_v1.Services.Service
...
var file_receptor_v1_receptor_proto_depIdxs = []int32{
	...
	10, // 3: receptor_v1.Struct.rows:type_name -> receptor_v1.Struct.Row
	9,  // 4: receptor_v1.Struct.col_display_names:type_name -> receptor_v1.Struct.ColDisplayNamesEntry
	13, // 5: receptor_v1.Services.services:type_name -> receptor_v1.Services.Service
	11, // 6: receptor_v1.Struct.Row.cols:type_name -> receptor_v1.Struct.Row.ColsEntry
	12, // 7: receptor_v1.Struct.Row.ColsEntry.value:type_name -> receptor_v1.Struct.Row.Value
	14, // 8: receptor_v1.Struct.Row.Value.timestamp_value:type_name -> google.protobuf.Timestamp
	0,  // 9: receptor_v1.Receptor.Report:input_type -> receptor_v1.Finding
	4,  // 10: receptor_v1.Receptor.Discovered:input_type -> receptor_v1.Services
	...
	8,  // 13: receptor_v1.Receptor.Notify:input_type -> receptor_v1.JobResult
	15, // 14: receptor_v1.Receptor.Report:output_type -> google.protobuf.StringValue
	15, // 15: receptor_v1.Receptor.Discovered:output_type -> google.protobuf.StringValue
	16, // 16: receptor_v1.Receptor.Verified:output_type -> google.protobuf.Empty
	7,  // 17: receptor_v1.Receptor.GetConfiguration:output_type -> receptor_v1.ReceptorConfiguration
	16, // 18: receptor_v1.Receptor.Notify:output_type -> google.protobuf.Empty
...
func file_receptor_v1_receptor_proto_init() {
	...
	file_receptor_v1_receptor_proto_msgTypes[12].OneofWrappers = []interface{}{
